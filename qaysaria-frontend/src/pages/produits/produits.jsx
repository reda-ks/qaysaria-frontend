...
const Produits = () => {
  ...
  const filteredShops = useMemo(() => {
    return allShops.filter((shop) => {
      // Search — matches name, description, city, marque
      if (searchQuery) {
  ...
  return (
    <div className="produits-page">
      ...
      <div className="magasins-header">
        ...
        <p className="magasins-subtitle">Découvrez les meilleures boutiques du Maroc</p>
      </div>
        ...
        <div className="produits-main">
          ...
          <div className="produits-results-bar">
            ...
            <span className="results-count">
              ...
              magasin{filteredShops.length !== 1 ? 's' : ''} trouvé{filteredShops.length !== 1 ? 's' : ''}
            </span>
          </div>
                  ...
                  <div className="shop-content">
                    ...
                    <div className="shop-meta">
                      <span className="shop-city">
                        📍 {shop.city.charAt(0).toUpperCase() + shop.city.slice(1)}
                      </span>
